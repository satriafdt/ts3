    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <?= form_open_multipart('User_Manage/Add_user'); ?>
            ...
            <div class="col-sm-6">
              <select name="client_id" id="client_id" class="form-control">
                ...
                <?php foreach ($client as $c) :   ?>
                  <option value="<?= $c['id']; ?>" <?php echo set_select('client_id', $c['id']); ?>> <?= $c['client_name'];  ?></option>
                <?php endforeach;   ?>
              </select>
            </div>
          </div>
            ...
            <div class="col-sm-6">
              <select name="id_role" id="id_role" class="form-control">
                ...
                <?php foreach ($role as $r) :   ?>
                  <option value="<?= $r['id']; ?>" <?php echo set_select('id_role', $r['id']); ?>> <?= $r['role'];  ?></option>
                <?php endforeach;   ?>
              </select>
            </div>
          </div>
            ...
            <div class="col-sm-6">
              <select name="regional_id" id="regional_id" class="form-control">
                ...
                <?php foreach ($regional as $rg) :   ?>
                  <option value="<?= $rg['id']; ?>" <?php echo set_select('regional_id', $rg['id']); ?>> <?= $rg['regional_name'];  ?></option>
                <?php endforeach;   ?>
              </select>
            </div>
          </div>
            ...
            <div class="col-sm-6">
              <select name="area_id" id="area_id" class="form-control">
                ...
                <?php foreach ($area as $ar) :   ?>
                  <option value="<?= $ar['id']; ?>" <?php echo set_select('area_id', $ar['id']); ?>> <?= $ar['area_name'];  ?></option>
                <?php endforeach;   ?>
              </select>
            </div>
          </div>
            ...
            <div class="col-sm-6">
              <select name="branch_id" id="branch_id" class="form-control">
                ...
                <?php foreach ($branch as $b) :   ?>
                  <option value="<?= $b['id']; ?>" <?php echo set_select('branch_id', $b['id']); ?>> <?= $b['branch_name'];  ?></option>
                <?php endforeach;   ?>
              </select>
            </div>
          </div>
